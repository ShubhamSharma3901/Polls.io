...
// Connect to MongoDB
mongoose_1.default.connect("mongodb+srv://shubham3901:Dkpmhnnmh%40007@cluster0.mbslhws.mongodb.net/miniproject").then(function () {
...
app.post("/polls", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                newPoll = new polls_1.default({
                    question: question,
                    options: options.map(function (option) { return ({ name: option, votes: 0 }); })
                });
...
app.get("/polls", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var polls, error_2;
...
app.post("/polls/:id/vote", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                poll = _a.sent();
                if (!poll)
                    return [2 /*return*/, res.status(404).json({ error: "Poll not found" })];
                pollOption = poll.options.find(function (opt) { return opt.name === option; });
