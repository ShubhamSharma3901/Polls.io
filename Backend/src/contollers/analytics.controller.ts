...
export const getTopPollsController = async (
  req: express.Request,
  ...
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server Error(Couldn't get Top Polls)" })
      .end();
  }
};

export const getUserEngagementController = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server Error(Couldn't get User Engagement)" })
      .end();
  }
};

export const getPopularPollOptionsController = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
    ...
    return res
      .status(500)
      .json({
        error: "Internal Server Error (Couldn't get Popular Poll Options)",
      })
      .end();
  }
};

export const getVoteTrendsController = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server Error(Couldn't get Vote Trends)" })
      .end();
  }
};
